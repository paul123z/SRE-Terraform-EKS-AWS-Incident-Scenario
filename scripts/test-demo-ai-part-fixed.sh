#!/bin/bash
# Test script to debug the AI analysis display part with existing incident ID
...
# Test the AI analysis part with existing incident ID
echo "=== Testing AI Analysis Display Part (Fixed) ==="
echo ""

# Use an existing incident ID that has logs
INCIDENT_ID="demo-incident-20250807-212048"

print_status "Testing AI analysis with existing incident ID: $INCIDENT_ID"
echo ""
